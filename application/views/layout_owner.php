...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" href="<?php echo base_url() . 'assets/assets-landing/image/icon-11.png' ?>">
        ...
        <div class="layout">
            ...
            <div class="page-container">
                ...
                <footer class="content-footer">
                    <div class="footer">
                        <div class="copyright">
                            <span>Copyright © 2021 <b class="text-dark"></b>. All rights reserved.</span>
                        </div>
                    </div>
                </footer>
                <!-- Footer END -->
